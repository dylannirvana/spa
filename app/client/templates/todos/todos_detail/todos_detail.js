...
Template.TodosDetail.helpers({
  ...
  user: function() {
    var todo = this;
    return Meteor.users.findOne({_id: todo.userId}); // instead of this.userId
  }
});
...
/*****************************************************************************/
Template.TodosDetail.onCreated(function () {
});

Template.TodosDetail.onRendered(function () {
});

Template.TodosDetail.onDestroyed(function () {
});
